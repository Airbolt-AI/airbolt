...
const config = {
  ...
  mutate: [
    ...
    'apps/backend-api/src/auth/jwt-verifier.ts', // JWT verification with critical decision points
    'apps/backend-api/src/auth/issuer-validator.ts', // Issuer validation decisions
    'apps/backend-api/src/auth/exchange-rate-limiter.ts', // Rate limit calculations - requests > limit
