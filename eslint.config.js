...
export default tseslint.config(
  ...
  {
    // SDK package - stricter type safety for external consumers
    ...
    rules: {
      ...
      // Note: These rules are smart enough to allow 'unknown' in catch blocks
      // and for error parameters, which is TypeScript best practice
    },
  },
  {
